...
function absolutizeAttribute(attribs: Record<string, string>, name: 'href' | 'src'): Record<string, string> {
...
export async function renderRssContent(container: AstroContainer, entry: BlogEntry): Promise<string> {
