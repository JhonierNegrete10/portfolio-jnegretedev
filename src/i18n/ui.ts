...
export const ui = {
  es: {
    ...
    blog: {
      ...
      breadcrumbsAria: 'Migas de navegación',
      seriesSectionAria: 'Series de artículos',
      chronologicalAria: 'Todos los artículos, orden cronológico',
      seriesLabel: 'Serie',
      pieceLabel: 'Pieza',
      ofLabel: 'de',
      readMinutes: 'min de lectura',
      toc: 'Índice',
      inThisSeries: 'En esta serie',
      seriesNavigationAria: 'Artículos de esta serie',
      limitsTitle: 'Límites y prerequisitos',
      prerequisitesTitle: 'Prerequisitos',
      limitationsTitle: 'Límites',
      previous: '← Anterior',
      nextStep: 'Siguiente paso práctico →',
      previousNextAria: 'Navegación entre artículos',
      baseGuide: 'Guía base',
  ...
  en: {
    ...
    blog: {
      ...
      seriesSectionAria: 'Post series',
      chronologicalAria: 'All posts, chronological order',
      seriesLabel: 'Series',
      pieceLabel: 'Part',
      ofLabel: 'of',
      ...
      seriesNavigationAria: 'Posts in this series',
      limitsTitle: 'Limits and prerequisites',
      prerequisitesTitle: 'Prerequisites',
      limitationsTitle: 'Limits',
      previous: '← Previous',
