...
function assertFlatBlogContent(
  directory: string,
  relativeDirectory = "",
): void {
  ...
  schema: ({ image }) =>
    z
          ...
          .array(
            z
              ...
              .refine(
                ...
                "tags must contain lowercase strings",
              ),
          )
      ...
      .refine(
        ...
        {
          message:
            "series and seriesOrder must both be present or both be absent",
          path: ["series"],
        },
      )
      .refine(
        (data) =>
          data.series === undefined || Object.hasOwn(series, data.series),
        {
